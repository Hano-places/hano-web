  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Button type="submit" className="w-full bg-white text-black hover:bg-brand-dark-100 transition-colors">
          Sign in
        </Button>
        ...
        <Button
          ...
          className="w-full bg-brand-dark-800 border-brand-dark-600 text-white hover:bg-brand-dark-700 transition-colors"
        >
