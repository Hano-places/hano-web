...
export default function SuperAdminDashboardContent() {
    ...
    const { user, logout } = useAuth(); // Added logout here as it's used in the menu
    ...
    const menu: SidebarMenuSection[] = [
        ...
        {
            section: "Account",
            items: [{ icon: LogOut, label: "Sign Out", onClick: logout }], // Changed href to onClick logout to match previous functionality
        },
    ];
