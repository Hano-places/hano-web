...
// Dynamic import for ActivityTrendChart
...
export default function SuperAdminDashboardPage() {
    ...
    const latestPicks = [
        ...
        },
        {
            ...
            image:
                "https://images.pexels.com/photos/271639/pexels-photo-271639.jpeg?auto=compress&cs=tinysrgb&w=640",
            price: "250",
            tag: "New Deal",
            logo: "/logo.png",
        },
        {
            ...
            image:
                "https://images.pexels.com/photos/1571459/pexels-photo-1571459.jpeg?auto=compress&cs=tinysrgb&w=640",
            price: "250",
            tag: "New Deal",
            logo: "/logo.png",
        },
                    ...
                    <div className="space-y-6">
                        <div className="bg-brand-dark-900 border border-gray-800 rounded-xl p-6 h-full">
                            <div className="flex items-center justify-between mb-4">
                                <h3 className="text-brand-dark-50 font-semibold">
                                                ...
                                                formatter={(value, name) => (
                                                    <div className="flex w-full justify-between">
                                                        ...
                                                        <span className="font-mono">
                                                            {((Number(value) / totalCategories) * 100).toFixed(
                                                                1
                                                            )}
                                                            %
                                                        </span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-4 flex flex-col">
                        <div className="flex items-center justify-between px-1">
                            ...
                            <a
                                href="#"
                                className="text-sm text-brand-dark-300 hover:text-brand-dark-100"
                            >
                                View All →
                            </a>
                        </div>
                        <div
                            className={"space-y-4 flex-1 overflow-y-auto no-scrollbar pr-2"}
                        >
                            {paginatedPicks.map((p, idx) => (
                                <Card
                                    key={`${p.title}-${idx}`}
                                    className="relative border border-gray-800 overflow-hidden p-0 rounded-2xl"
                                >
                                    ...
                                    <div className="absolute inset-x-0 bottom-0 p-4">
                                        <div className="mx-2 mb-2 rounded-xl  p-3">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <h4 className="text-white text-lg font-semibold drop-shadow-sm truncate">
                                                    {p.title}
                                                </h4>
                                            </div>
                                            <div className="mt-2 text-white/90 text-sm">
                                                Get 10% of with Christmas Sales
                                            </div>
                        ...
                        <div className="flex items-center justify-center mt-4 gap-2 px-1">
                            ...
                            {getPageNumbers(totalPicksPages, currentPicksPage).map(
                                (page, index) =>
                                    page === "..." ? (
                                        <span
                                            key={`dots-${index}`}
                                            className="px-2 text-brand-dark-500"
                                        >
                                            ...
                                        </span>
                                    ) : (
                                        <button
                                            key={`page-${page}`}
                                            className={`w-8 h-8 rounded-lg text-sm font-medium transition-colors ${currentPicksPage === page
                                                    ? "text-brand-dark-100"
                            ...
                            <button
                                ...
                                onClick={() =>
                                    setCurrentPicksPage((p) => Math.min(totalPicksPages, p + 1))
                                }
                            >
